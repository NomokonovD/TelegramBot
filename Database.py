...
# #     ("Kazan", "Kazan Kremlin"),
# #     ("Chelyabinsk", "Chelyabinsk Tractor Plant"),
# #     ("Omsk", "Omsk State Circus"),
# #     ("Samara", "Samara Embankment"),
# #     ("Rostov-on-Don", "Rostov Arena")
# # ]
#
# # # Вставка данных в таблицу "city"
# # for city in russian_cities:
# #     cursor.execute('INSERT INTO city (name_city) VALUES (?)', (city[0],))
#
# # # Вставка данных в таблицу "attraction"
# # for city in russian_cities:
# #     cursor.execute('INSERT INTO attraction (name_attraction, name_city) VALUES (?, ?)', city)
#
#
# cities = [
#     ('Абаза'),
